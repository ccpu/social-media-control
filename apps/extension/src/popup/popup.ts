import type { SettingsData, VideoControlMode } from '@internal/core';
import { Browser, Settings, VideoAutoplayMode } from '@internal/core';
...
export class Popup {
  ...
  private initSettingControls() {
    ...
    this.initSettingSelectElement(
      ...
      (e) => {
        e.value = this.settings.videoControlMode;
      },
    );
    ...
    this.initSettingInputElement(
      ...
      (e) => {
        this.settings.autoHideControlBar = e.checked;
      },
      (e) => {
        e.checked = this.settings.autoHideControlBar;
      },
    );
    ...
    this.initSettingInputElement(
      ...
      (e) => {
        this.settings.showTimeCodeText = e.checked;
      },
      (e) => {
        e.checked = this.settings.showTimeCodeText;
      },
    );
    ...
    this.initSettingSelectElement(
      ...
      (e) => {
        this.settings.autoplayMode = e.value as VideoAutoplayMode;
      },
      (e) => {
        e.value = this.settings.autoplayMode;
      },
    );
    ...
    if (Browser.isFullscreenSupported) {
      this.initSettingInputElement(
        ...
        (e) => {
          this.settings.showFullscreenButton = e.checked;
        },
        (e) => {
          e.checked = this.settings.showFullscreenButton;
        },
      );
    } else {
    ...
    if (Browser.isPictureInPictureSupported) {
      this.initSettingInputElement(
        ...
        (e) => {
          this.settings.showPictureInPictureButton = e.checked;
        },
        (e) => {
          e.checked = this.settings.showPictureInPictureButton;
        },
      );
    } else {
      // Hide the setting if not supported.
    ...
    this.initSettingInputElement(
      ...
      (e) => {
        this.settings.showDownloadButton = e.checked;
      },
      (e) => {
        e.checked = this.settings.showDownloadButton;
      },
    );
    ...
    this.initSettingInputElement(
      ...
      (e) => {
        this.settings.showPlaybackSpeedOption = e.checked;
      },
      (e) => {
        e.checked = this.settings.showPlaybackSpeedOption;
      },
    );
    ...
    this.initSettingInputElement(
      ...
      (e) => {
        this.settings.loopPlayback = e.checked;
      },
      (e) => {
        e.checked = this.settings.loopPlayback;
      },
    );

    // Advance to the next video when playback ends.
    this.initSettingInputElement(
      'option_advance_on_video_end',
      (e) => {
        this.settings.advanceOnVideoEnd = e.checked;
      },
      (e) => {
        e.checked = this.settings.advanceOnVideoEnd;
      },
    );
  ...
  private setSettingHintVisibility(name: string, visibility: boolean) {
    let element = document.querySelector(`li:has([name="${name}"]) .hint`) as HTMLElement;

    if (!element) {
      element = document.querySelector(`[data-hint="${name}"]`) as HTMLElement;
    }
  ...
  private replaceLocaleTags() {
    ...
    for (const element of elements) {
      ...
      const { locale } = element.dataset;
      if (!locale) continue;

      element.textContent = this.translate(locale);
    }
  }
