...
export class Browser {
  ...
  public static get storage(): typeof browser.storage | typeof chrome.storage {
    return this.current.storage;
  }

  // Returns the internationalization object for the current browser.
  public static get i18n(): typeof browser.i18n | typeof chrome.i18n {
  ...
  public static get isFullscreenSupported(): boolean {
  ...
  public static get isPictureInPictureSupported(): boolean {
